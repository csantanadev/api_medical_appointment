...
const createDoctorInfoUseCase = new CreateDoctorInfoUseCase(doctorPrismaRepository, doctorInfoPrismaRepository);

const createDoctorInfoController = new CreateDoctorInfoController(createDoctorInfoUseCase);
