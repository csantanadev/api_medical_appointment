...
import { IDocotorRepository } from "../../repositories/doctor.repository";
...
export class CreateDoctorUseCase {
    ...
    constructor(private userRepository: IUserRepository, private doctorRepository: IDocotorRepository) {}
